...
echo '  Sum: ' . $aps;
    ...
    if($aps >=19 && $aps < 21)
    {
        header("location: ../user-dashboard/qualification/certificate.php?uni=$university&aps=$aps");

    }elseif($aps >=21 && $aps < 30){
        header("location: ../user-dashboard/qualification/diploma.php?uni=$university&aps=$aps");

    }elseif($aps >=30 && $aps <= 42) {
        header("location: ../user-dashboard/qualification/degree.php?uni=$university&aps=$aps");
